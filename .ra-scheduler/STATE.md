...
last_run: 2026-05-03T03:00+09:00
last_issue: 12
current_status: done
next_candidate: MDR Declaration of Conformity (DoC) 양식·작성 지침
run_count: 14
carryover_issue: (없음)
...
missed_run_count_approx: 3
missed_ep_total: 7
catchup_note: 2026-04-24 ~ 2026-04-29 사이 미실행 누적. CATCHUP 모드 진행 중 (잔여 7 EP). 이번 회차 EP:4 소비.
...
ep_completed: 32
ep_remaining: 106
ep_completion_pct: 23.2

### 속도 추적
velocity_7day_ep: 4.0
velocity_30day_ep: (미집계)
runs_normal: 10
runs_catchup: 8

### 완료 예측
estimated_done_optimistic: 2026-05-19
estimated_done_conservative: 2026-06-06
estimated_done_basis: 잔여 EP 106 기준. optimistic=6 EP/일(정상 2회 가동), conservative=4.0 EP/일(7일 실속도).
