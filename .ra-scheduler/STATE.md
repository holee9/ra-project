...
last_issue: 41
current_status: done
next_candidate: FDA Threat Model 작성 가이드·STRIDE 기반 샘플 [EP:2]
run_count: 33
carryover_issue: (없음)
...
run_ep_budget_today_remaining: 0  # 19:30 CATCHUP 회차 EP:1×4 = 4 EP 전액 소비

### 누적 EP 실적
ep_total: 138
ep_completed: 82
ep_remaining: 56
ep_completion_pct: 59.4
...
estimated_done_basis: 잔여 EP 56 기준. optimistic=6 EP/일(정상 2회 가동), conservative=5.1 EP/일(7일 실속도).
...
- 2026-05-11 03:00 (#31) [EP:2] ISO 13485:2016 절차서 목록 (섹션 4~8)·뼈대 (EP:2). 예산 3 EP 중 2 EP 소비, 잔여 1 EP. commit d4da287. Issue #31 close.
