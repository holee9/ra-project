...
- 2026-06-15 07:00 [weekly] 주간 모니터 #3 — 신규 규제변경 없음. 6소스 폴링(openFDA recall 7건 전부 비관련[압축스테이플·치과세라믹·이식형기기·약품]·enforcement 최신 2026-06-03[기간외]·Federal Register FDA 11건 전부 비관련[면역·ENT기기분류·약품·행정]·EUR-Lex MDR 8개 known 변경없음·law.go.kr 행정규칙 최신 2026-05-19/현행법령 최신 2026-01-02 신규없음·data.go.kr 추적관리 640[변동없음]). 고/중영향 0건, KB갱신·이슈 없음. watermark→2026-06-15.
- 2026-06-17 07:00 [weekly] 주간 모니터 #4 — **신규 1건 고영향 감지**. Federal Register **2026-12166** (91 FR 36522, Doc# FDA-2026-N-6535, 2026-06-17 발효·Final Order) "Radiology Devices; Classification of the Radiological **Machine Learning-Based Quantitative Imaging Software With Predetermined Change Control Plan**" → **21 CFR 892.2055 신설, Class II + special controls(설계 V&V·학습데이터·하위집단·SW V&V·계획변경·위험관리·라벨링 PCCP 버전이력)**. 자사 P3 촬영실 GUI SW에 직접 영향(AI 정량영상 기능 탑재 시 적용). KB 갱신: `01_규제지식베이스/미국_FDA/FDA_AI_ML_2026_PCCP_운영_TPLC_업데이트.md` §8 신규섹션 추가. 기타 FR 5건(debarment/Gastro 분류/Drug 11건 승인철회/Org info 규칙/Form 3542 약품) 전부 비관련. EUR-Lex MDR 8개 known 변동없음·IVDR 4개 모두 historical(추가 known 등록 2건)·openFDA recall/enforcement 0건·law.go.kr 행정규칙/현행법령 신규 0건·data.go.kr 추적관리 640→641[+1 저출력심장충격기, 저영향]. watermark→2026-06-17.
